...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("file1_tree.json", "file2_tree.yaml", "expected_tree_stylish_output.txt", "stylish"),
        ("file1_tree.json", "file2_tree.yaml", "expected_plain_output.txt", "plain"),
    ]
)


def test_generate_diff(file1, file2, expected_file, format_of_output, load_file_content, fixture_path):
